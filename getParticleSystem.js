//Source Code from RobotBobby, “Learn Three.js: Simple Particle Effects"
...
function getParticleSystem(params) {
  ...
  alphaSpline.addPoint(0.0, 0.6);
  alphaSpline.addPoint(0.0, 1.0);
  alphaSpline.addPoint(0.6, 0.0);
  ...
  function _AddParticles(timeElapsed) {
    ...
    for (let i = 0; i < n; i += 1) {
      ...
      _particles.push({
        ...
        rotationRate: Math.random() * 0.01 - 0.05,
  ...
  return { update, start, stop, updatePosition };
}
